...
public class CourseController {
    ...
    // — permitAll 경로라 @AuthenticationPrincipal을 그대로 못 쓴다(CurrentUserResolver 참고).
    @GetMapping("/public")
    public ApiResponse<CourseResponseDTO.PublicCourseResult> getPublicCourses(
        ...
        return ApiResponse.onSuccess(
                courseQueryService.getPublicCourses(CurrentUserResolver.resolveOptionalUserId(), PageRequest.of(page, size))
        );
    }
